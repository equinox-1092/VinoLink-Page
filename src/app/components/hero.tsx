  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center p-4 md:p-8 max-w-7xl mx-auto w-full animate-fade-in-down animate-duration-1000">
      <div className="w-full md:w-1/2 text-center md:text-left p-4">
        <h1 className="text-7xl md:text-7xl font-bold py-7 flex items-baseline">
          <span>Vino</span>
          <span className="text-blue-600">
            <PointerHighlight>Link</PointerHighlight>
          </span>
        </h1>

        <div className="space-y-4">
          <p className="text-lg md:text-xl">
            Join the VinoLink community and start connecting with wineries
            today!
          </p>
